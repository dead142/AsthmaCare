...
<?= GridView::widget([
    ...
    'columns' => [
        ...
        [
            'attribute' => 'fullName',
            'value' => 'profile.fullName', # 90px is sufficient for 5-digit user ids
        ],

//        [
//            'attribute' => 'userRole',
//            'value' => function ($model) {
//                return Yii::t('B-User', $model->userRole);
//            },
//            'filter' => [
//                "teacher" => Yii::t('B-User', 'teacher'),
//                "student" => Yii::t('B-User', 'student'),
//                "admins" => Yii::t('B-User', 'admins')
//            ],
//        ],
        'email:email',
